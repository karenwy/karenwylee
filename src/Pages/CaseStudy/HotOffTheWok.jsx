        ...
        <section id="CaseStudy" className="section">
          <div className="container">
            ...
            <div className='reveal-up mb-6'>
              <p className='mb-2'>When LKK collaborated with celebrity chef Ching He Huang on a 'Hot Off the Wok' mini-series I helped create a site focusing on this series.</p>
