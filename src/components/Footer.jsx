...
const caseStudies = [
  {
    label: 'Cake Calculator',
    href: '/case-study/cake'
  },
  {
    label: 'Trip Mates',
    href: '/case-study/trip-mates'
  },
  {
    label: 'Alertr',
    href: '/case-study/alertr'
  },
  {
    label: 'Cobalt Health',
    href: '/case-study/cobalt-health'
  }, 
  // {
  //   label: 'Olu Olu Foods', 
  //   href: 'case-study/olu-olu-foods'
  // }, 
  // {
  //   label: 'Hot Off The Wok',
  //   href: '/case-study/hot-off-the-wok'
  // }
];
      ...
      <div className="container">
        ...
        <div className="lg:grid grid-cols-2">
            ...
            <div className="flex items-center gap-2 mt-4">  
              {socialLinks.map(({href, icon, alt}, key) => (
                <a key={key} href={href} alt={alt} target="_blank" 
                  className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50 hover:text-violet-500 active:bg-zinc-50/80 reveal-up">
                  {icon}
                </a>
              ))}
            </div>
          ...
          <div className="grid grid-cols-2 gap-4 lg:pl-20">
            ...
            <div>
              <p className="mb-2 reveal-up">Featured Work</p>
              <ul>
                {
