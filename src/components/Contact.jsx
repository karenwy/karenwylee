        ...
        <form onSubmit={handleSubmit} action="" method="POST" className="xl:pl-10 2xl:pl-20">
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input type="text" name="name" id="name" autoComplete="name" required placeholder="Your Name" className="text-field" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
            ...
            <div className="mb-4">
              ...
              <input type="email" name="email" id="email" autoComplete="email" required placeholder="Your Email" className="text-field" value={email} onChange={(e) => setEmail(e.target.value)}/>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea name="message" id="message" required placeholder="Your message" className="text-field resize-y min-h-32 max-h-80" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
          </div>

          <button type="submit" className="btn btn-primary [&]:max-w-full! w-full! justify-center">Send</button>
