...
const socialLinks = [
  ...
  {
    href: 'https://www.linkedin.com/in/karen-wing-yee-lee-39173892/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 3h18a1 1 0 0 1 1 1v16a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1zm9.06 8.683L5.648 6.238 4.353 7.762l7.72 6.555 7.581-6.56-1.308-1.513-6.285 5.439z" fill="currentColor" />
    </svg>,
    alt: 'Email'
  },
  {
    href: 'https://www.instagram.com/winggfashion',
...
const Contact = () => {
  ...
  // process form with external PHP 
  ...
  const handleSubmit = async (e) => {
    ...
    const res = await fetch('http://sendemail.karenwylee.co.uk/submit.php', {
      method: 'POST', 
      body: formData
    });
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <div className="flex items-center gap-2">  
              {socialLinks.map(({href, icon, alt}, key) => (
                <a key={key} href={href} alt={alt} target="_blank" 
        ...
        <form onSubmit={handleSubmit} action="" method="POST" className="xl:pl-10 2xl:pl-20">
          
          {response && <div className="mb-4 text-lg text-violet-300 rounded-xl max-w-[35ch]">{response}</div>}
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input type="text" name="name" id="name" autoComplete="name" required placeholder="Your Name" className="text-field reveal-up" value={name} onChange={(e) => setName(e.target.value)} />
            </div>
            ...
            <div className="mb-4">
              ...
              <input type="email" name="email" id="email" autoComplete="email" required placeholder="Your Email" className="text-field  reveal-up" value={email} onChange={(e) => setEmail(e.target.value)}/>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea name="message" id="message" required placeholder="Your message" className="text-field resize-y min-h-32 max-h-80  reveal-up" value={message} onChange={(e) => setMessage(e.target.value)}></textarea>
          </div>

          <button type="submit" className="btn btn-primary [&]:max-w-full! w-full! justify-center reveal-up">Send</button>
