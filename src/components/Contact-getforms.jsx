...
const Contact = () => {
  ...
  // only 25 submissions with free trial :( 
  const GETFORM_ENDPOINT = "https://getform.io/f/apjpxrna";
        ...
        <form onSubmit={handleSubmit} className="xl:pl-10 2xl:pl-20">
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              ...
              <input type="text" name="name" id="name" autoComplete="name" required placeholder="Your Name" className="text-field" value={formData.name} onChange={handleChange}/>
            </div>
            ...
            <div className="mb-4">
              ...
              <input type="email" name="email" id="email" autoComplete="email" required placeholder="Your Email" className="text-field" value={formData.email} onChange={handleChange}/>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea name="message" id="message" required placeholder="Your message" className="text-field resize-y min-h-32 max-h-80" value={formData.message} onChange={handleChange}></textarea>
          </div>

          <button type="submit" disabled={formStatus.submitting} className="btn btn-primary [&]:max-w-full! w-full! justify-center disabled:opacity-50 disabled:cursor-not-allowed">{formStatus.submitting ? "Sending..." : "Send"}</button>
